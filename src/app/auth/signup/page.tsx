    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-b from-gray-950 via-[#0d2562] to-blue-700 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative">
          <p className="text-blue-300 text-xs font-bold tracking-[0.2em] uppercase mb-4">Únete gratis hoy</p>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16 bg-white">
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-500 text-sm">Sin tarjeta de crédito · Primer curso gratis</p>
          </div>
          ...
          <form action={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                required
                autoComplete="name"
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400"
